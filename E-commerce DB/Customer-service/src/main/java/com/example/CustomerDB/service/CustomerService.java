...
public class CustomerService {
    ...
    public List<CustomerDetails> getCustomers(String email){
    ...
    public String addAddress(String email,AddressDetails newAddress){
        List<CustomerDetails> customerDetails=customerRepository.findAll();
        List<AddressDetails> addressDetailsList=addressRepository.findByEmail(email);
        Optional<AddressDetails> existingAddress=addressDetailsList.stream().filter(x->x.getEmail().equals(email) && x.getType().equals(newAddress.getType())).findFirst();
        ...
        if(res.isPresent() ){
            ...
            return "Address already present in the database, enter a new address";
