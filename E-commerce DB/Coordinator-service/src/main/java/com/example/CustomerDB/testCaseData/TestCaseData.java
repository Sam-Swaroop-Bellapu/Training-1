...
//        List<CustomerDetails> customersList=customerRepository.findAll();
    ...
    public static List<ProductDetails> addProductListTest(){
        ...
        public static InventoryDetails addInventory(){
            InventoryDetails newInventory=new InventoryDetails();
            newInventory.setSkuCode("sku1");
            newInventory.setQuantityAvailable(20);
            return newInventory;
        }
